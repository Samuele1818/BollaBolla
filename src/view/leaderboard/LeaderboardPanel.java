...
public class LeaderboardPanel extends JPanel implements Observer {
     ...
     *
     * @param leaderboard observable class to subscribe to
     */
    ...
    /**
     * Modify leaderboard records
     *
     * @param newRecords new list of records
     */
    private void setLeaderboard(ArrayList<LeaderboardRecord> newRecords) {
        // Clear old rows
        model.setRowCount(0);
    ...
    /**
     * Modify table data when leaderboard is updated, refresh table
     *
