...
public abstract class Enemie extends Monster {
    private int deadSize;
    public Enemie(int x, int y, Type type) {
    ...
    public Enemie(int x, int y, Type type, int speed) {
        this(x, y,type, speed, "walk_right.gif",Level.Direction.RIGHT);
    }
    public Enemie(int x, int y, Type type, int speed, String path, Level.Direction direction) {
